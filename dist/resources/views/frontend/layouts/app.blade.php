            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse d-none d-xl-block d-none d-xl-block" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{route('searchCourse')}}">Cursos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{route('about')}}">Sobre Nosotros</a>
                        </li>
                        {{-- <li class="nav-item">
                    ...
                    <div class="d-flex align-items-center justify-content-between rightContent">
                        ...
                        <a href="{{route('cart')}}" class="cart-nav border-0 bg-transparent mx-3">
                            ...
                            <span class="visually-hidden">Items Agregados</span>
                        </a>
                        ...
                        <div class="dropdown user-image ms-3" id="imageDropdown">
                            ...
                            <div class="dropdown-content">
                                <a href="{{route('student_profile')}}">Perfil</a>
                                <a href="{{route('studentdashboard')}}">Dashboard</a>
                                <a href="{{route('studentlogOut')}}" class="text-danger">Cerrar Sesión</a>
                            </div>
                        </div>
                        @else
                        <a href="{{route('studentLogin')}}" class="button button--text">Iniciar Sesión</a>
                        <a href="{{route('studentRegister')}}" class="button button--dark">Registrarse</a>
                        @endif
                    </div>
                </div>
                        ...
                        <div class="navbar-mobile__menu">
                            <ul class="navbar-mobile__menu-list">
                                <li class="active navbar-mobile__menu-item">
                                    <a href="{{route('home')}}">
                                        <span class="navbar-mobile__menu-link"> Inicio</span>
                                    </a>
                                </li>
                                <li class="navbar-mobile__menu-item">
                                    <a href="{{route('searchCourse')}}">
                                        <span class="navbar-mobile__menu-link"> Cursos </span>
                                    </a>
                                </li>
                                <li class="navbar-mobile__menu-item">
                                    <a href="{{route('about')}}">
                                        <span class="navbar-mobile__menu-link"> Sobre Nosotros </span>
                                    </a>
                                </li>
                                <li class="navbar-mobile__menu-item">
                                    <a href="#">
                                        <span class="navbar-mobile__menu-link"> Páginas </span>
                                    ...
                                    <ul class="navbar-mobile__menu-dropmenu">
                                        <li><a href="{{route('searchCourse')}}">Cursos</a></li>
                                        <li><a href="{{route('student_profile')}}">Perfil de Estudiante</a></li>
                                ...
                                <li class="navbar-mobile__menu-item">
                                    <a href="{{route('contact')}}">
                                        <span class="navbar-mobile__menu-link"> Contacto </span>
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-sm-4 col-6">
                    <div class="footer__list">
                        ...
                        <ul>
                            ...
                            <li><a href="course-search.html">Cursos</a></li>
                ...
                <div class="col-lg-2 col-sm-4 col-6">
                    <div class="footer__list">
                        <h6>Quick Links</h6>
                        <ul>
                            <li><a href="event-search.html">Eventos</a></li>
                            <li><a href="become-instructor.html">Conviertete en Instructor</a></li>
            ...
            <div class="container">
                <div class="footer__bottom-content">
                    <div class="footer__bottom_copyright">
                        <p>© 2024 - Eduguard. Todos los Derechos Reservados</p>
                    </div>
