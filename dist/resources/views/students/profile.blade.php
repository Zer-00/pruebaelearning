    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center bg-transparent mb-0">
                <li class="breadcrumb-item"><a href="index.html" class="fs-6 text-secondary">Inicio</a></li>
                <li class="breadcrumb-item fs-6 text-secondary" aria-current="page">Mi Perfil</li>
            </ol>
        </nav>
    </div>
</div>
                    ...
                    <div class="students-info-intro-end">
                        <div class="enrolled-courses">
                            ...
                            <div class="enrolled-courses-text">
                                ...
                                <p class="fs-6 mt-1">Cursos Inscritos</p>
                            </div>
                        </div>
                        <div class="completed-courses">
                            ...
                            <div class="completed-courses-text">
                                ...
                                <p class="fs-6 mt-1">Cursos Completados</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <nav class="students-info-intro__nav">
                <div class="nav" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab"
                        ...
                        aria-selected="true">Mi Perfil</button>

                    <button class="nav-link" id="nav-setting-tab" data-bs-toggle="tab" data-bs-target="#nav-setting"
                        type="button" role="tab" aria-controls="nav-setting" aria-selected="false">Ajustes</button>
                </div>
            </nav>
        </div>
                    ...
                    <div class="tab-content__profile">
                        <div class="tab-content__profile-content">
                            <div class="about-student">
                                <h6 class="font-title--card">Sobre Mi</h6>
                        ...
                        <div class="tab-content__profile-content">
                            <div class="info-student">
                                <h6 class="font-title--card">{{$student_info->name_en}}'s Información:</h6>
                        ...
                        <div class="col-lg-9 order-2 order-lg-0">
                            <div class="white-bg">
                                <div class="students-info-form">
                                    <h6 class="font-title--card">Tu Información</h6>
                                    <form action="{{route('student_save_profile')}}" method="post">
                                        @csrf
                                        <div class="row g-3">
                                            <div class="col-lg-6">
                                                <label for="fullName_en">Nombre completo</label>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <label for="profession">A qué te dedicas</label>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-lg-6">
                                                <label for="contactNumber_en">Teléfono</label>
                                        ...
                                        <div class="d-flex justify-content-lg-end justify-content-center mt-2">
                                            <button class="button button-lg button--primary" type="submit">Guardar
                                                Cambios</button>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="white-bg mt-4">
                                <div class="students-info-form">
                                    <h6 class="font-title--card">Cambiar Contraseña</h6>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-with-icon">
                                                    <input type="password" id="npass" name="password"
                                                        class="form-control" placeholder="Escribe tu nueva contraseña" />
                                    ...
                                    <form id="changeImageForm" action="{{ route('change_image') }}" method="post"
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <button type="button" id="changeImageButton"
                                                class="button button--primary-outline">CAMBIAR IMAGEN</button>
                                        </div>
                                    </form>
                                    <p>La Imagen debe pesar menos de 1MB y tener un ratio de 200px.</p>
                                </div>
                            </div>
                        </div>
                    </div>
