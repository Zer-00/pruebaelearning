        ...
        <div class="row align-items-center">
            <div class="col-xl-5 order-2 order-xl-0">
                <div class="signup-area-textwrapper">
                    <h2 class="font-title--md mb-0">Iniciar Sesión</h2>
                    <p class="mt-2 mb-lg-4 mb-3">¿No tienes cuentas? <a href="{{route('studentRegister')}}"
                            class="text-black-50">Registrarse</a>
                        </p>
                    <form action="{{route('studentLogin.check','studentdashboard')}}" method="POST">
                        ...
                        <div class="form-element">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="forget-password.html" class="text-primary fs-6">Olvidé mi contraseña</a>
                            </div>
                        ...
                        <div class="form-element d-flex align-items-center terms">
                            ...
                            <label for="agree" class="text-secondary mb-0 fs-6">Recuerdame</label>
                        </div>
                        <div class="form-element">
                            <button type="submit" class="button button-lg button--primary w-100">Iniciar sesión</button>
                        </div>
                    </form>
                </div>
            </div>
