        ...
        <div class="row">
            <div class="col-lg-7 mb-lg-0 order-2 order-lg-0 d-flex align-items-center">
                <div class="banner-two-start">
                    <h1 class="font-title--lg">Desbloquea El Conocimiento En Cualquier Lugar Y Cualquier Momento Con Expertos.</h1>
                    <p>
                        Nuestro compromiso es guiarte a los mejores cursos online, ofreciendo experticia cuando y donde quiera que estés.
                    </p>
                    <form>
                        <div class="banner-input">
                            ...
                            <div class="search-button">
                                <button class="button button-lg button--primary">Buscar</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<section class="section browse-categories">
    <div class="container">
        <h2 class="font-title--md text-center mb-0">Buscar Cursos en las Categorías Top</h2>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="{{route('searchCourse')}}" class="button button-lg button--primary mt-5">Buscar Todos Los Cursos</a>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="featured-popular-courses-heading d-flex align-content-center justify-content-between">
                    <div class="main-heading">
                        <h3 class="font-title--md">Los Más Populares</h3>
                    </div>
        ...
        <div class="row">
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$pc->price?'$'.$pc->price:'Gratis'}}</span>
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$pc->lesson?$pc->lesson:0}} Lecciones</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            ...
                                            <span>{{$pc->duration?$pc->duration:0}} Horas</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <a href="{{route('searchCourse')}}" class="button button-lg button--primary">Buscar Todos Los 
                                Cursos</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$dc->price?'$'.$dc->price:'Gratis'}}</span>
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$dc->lesson?$dc->lesson:0}} Lecciones</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{asset('frontend/dist/images/icon/Clock.png')}}" alt="clock" />
                                            </div>
                                            <span>{{$dc->duration?$dc->duration:0}} Horas</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$dv->price?'$'.$dv->price:'Gratis'}}</span>
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$dv->lesson?$dv->lesson:0}} Lecciones</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{asset('frontend/dist/images/icon/Clock.png')}}" alt="clock" />
                                            </div>
                                            <span>{{$dv->duration?$dv->duration:0}} Horas</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$bc->lesson?$bc->lesson:0}} Lecciones</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{asset('frontend/dist/images/icon/Clock.png')}}" alt="clock" />
                                            </div>
                                            <span>{{$bc->duration?$bc->duration:0}} Horas</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$ic->price?'$'.$ic->price:'Gratis'}}</span>
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$ic->lesson?$ic->lesson:0}} Lecciones</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{asset('frontend/dist/images/icon/Clock.png')}}" alt="clock" />
                                            </div>
                                            <span>{{$ic->duration?$ic->duration:0}} Horas</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<section class="section feature section section--bg-offwhite-one">
    <div class="container">
        <h2 class="font-title--md text-center">¿Por Qué Aprender con Eduguard?</h2>
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="cardFeature">
                    ...
                    <h5 class="font-title--xs">250k cursos online</h5>
                    <p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="cardFeature">
                    ...
                    <h5 class="font-title--xs">Instructores Expertos</h5>
                    <p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="cardFeature">
                    ...
                    <h5 class="font-title--xs">Acceso de Por Vida</h5>
                    <p>
            ...
            <div class="col-lg-6 order-2 order-lg-0">
                <div class="learning-rules-starts">
                    <h2 class="font-title--md">
                        Los Sencillos Pasos <br class="d-none d-md-block" />
                        para Aprender con Eduguard
                    </h2>
                    <div class="learning-rules__wrapper">
                        <div class="learning-rules-item">
                            <div class="item-number"><span>01.</span></div>
                            <div class="item-text">
                                <h6>Haz Tu Lugar de Estudio.</h6>
                                <p>
                        ...
                        <div class="learning-rules-item">
                            ...
                            <div class="item-text">
                                <h6>Encuentra El Curso que Mejor Encaje Contigo.</h6>
                                <p>
                        ...
                        <div class="learning-rules-item">
                            ...
                            <div class="item-text">
                                <h6>Conviertete en un Experto en tu Área.</h6>
                                <p>
                    ...
                    <a href="#" class="button button-lg button--primary">Comienza a Aprender</a>
                </div>
            </div>
    ...
    <div class="container about-services-area">
        <div class="row">
            <div class="col-lg-6 text-center mx-auto">
                <h2 class="font-title--md">Que Dicen Nuestros Estudiantes Sobre Nuestros Servicios</h2>
            </div>
        </div>
                ...
                <div class="testimonial__user-wrapper d-flex justify-content-between">
                    <div class="testimonial__user d-flex align-items-center">
                        ...
                        <div class="testimonial__user-info">
                            <h6>Sheikh Rashed</h6>
                            <span class="font-para--md">Estudiante de UI/UX</span>
                        </div>
                    </div>
    ...
    <div class="container overflow-hidden">
        <div class="row mb-40">
            <div class="col-lg-6 mx-auto text-center brands-area-two-heading">
                <h4>
                    Más de 30,000+ Escuelas Y Universidades Aprenden Con Nostros.
                </h4>
                <p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 position-relative">
                <h3 class="text-center mb-40 font-title--md">Conoce a Nuestros Mejores Instructores</h3>
...
<section class="section section--bg-offwhite-three latest-events-featured main-events-featured">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="font-title--md">Últimos Eventos</h3>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="{{route('searchCourse')}}" class="button button-lg button--primary mt-lg-5 mt-5">Buscar Todos Los 
                    Eventos</a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="main-become-instructor-item me-12">
                    ...
                    <div class="main-text">
                        <h6 class="font-title--sm">Conviertete en Instructor</h6>
                        <p>
                        ...
                        <div class="text-center">
                            <a href="become-instructor.html" class="green-btn">Aplicar como Instructor</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="main-become-instructor-item ms-12 mb-0">
                    ...
                    <div class="main-text">
                        <h6 class="font-title--sm">Eduguard Para Empresas</h6>
                        <p>
                            Praesent ultricies nulla ac congue bibendum. Aliquam tempor euismod purus posuere
                            gravida. Praesent augue sapien, vulputate eu imperdiet eget, tempor at enim.
                        </p>
                        <div class="text-center">
                            <a href="#" class="green-btn">Obtener Eduguard para Empresas</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="newsletter-area">
                    ...
                    <form>
                        <div class="input-group">
                            <input type="email" class="form-control border-lowBlack" placeholder="Tu email" />
