        ...
        <div class="container-fluid">
            <div class="coursedescription-header">
                        ...
                        <div class="topic-info-text">
                            ...
                            <div class="lesson-hours">
                                <div class="book-lesson">
                                    ...
                                    <span>{{$course->lesson?$course->lesson:0}} Lección</span>
                                </div>
                                <div class="totoal-hours">
                                    <i class="far fa-clock text-danger"></i>
                                    <span>{{$course->duration?$course->duration:0}} Horas</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="coursedescription-header-end">
                    ...
                    <a href="#" class="button button--text" data-bs-toggle="modal" data-bs-target="#ratingModal">Dejar una
                        Calificación</a>

                    <!-- <a href="#" class="btn btn-primary regular-fill-btn">Next Lession</a> -->
                    <button class="button button--primary">Siguiente Lección</button>
                </div>
            </div>
        </div>
    </header>
                        ...
                        <div class="tab-content course-description-start-content-tabitem" id="nav-tabContent">
                                ...
                                <div class="course-notes-area">
                                    <div class="course-notes">
                                        <div class="course-notes-item">
                                            <p>
                                                Tienes que tomarte un minuto para entender cuál es el objetivo, cuál es el
                                                problema, qué están tratando de lograr con él, quién es el objetivo
                                                audiencia,
                                                ¿Quién es la competencia y entender?
                                                ¿Qué intentas hacer aquí y cómo será el éxito?
                                                el
                                                proyecto. la forma de hacerlo es básicamente haciendo dos cosas
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="nav-lcomments" role="tabpanel"
                                ...
                                <div class="lesson-comments">
                                    <div class="feedback-comment pt-0 ps-0 pe-0">
                                        <h6 class="font-title--card">Agregar un Comentario Público</h6>
                                        <form action="#">
                                            <label for="comment">Comentario</label>
                                            <textarea class="form-control" id="comment" placeholder="Agregar un Comentario Público"></textarea>
                                    ...
                                    <div class="students-feedback pt-0 ps-0 pe-0 pb-0 mb-0">
                                        <div class="students-feedback-heading">
                                            <h5 class="font-title--card">Comentarios <span>(57,685)</span></h5>
                                        </div>
                                        ...
                                        <button class="button button-md button--primary-outline">Cargar Más</button>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="nav-loverview" role="tabpanel"
                                ...
                                <div class="row course-overview-main">
                                    ...
                                    <div class="course-overview-main-item">
                                        <h6 class="font-title--card">Requerimientos</h6>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Dejar una Calificación</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center pt-0 pb-0">
                    <div class="modal-body-rating">
                        <p>4.5 <span>(Bueno/Asombroso)</span></p>
                ...
                <div class="modal-footer border-0">
                    <form action="#" class="w-100">
                        ...
                        <textarea id="messages" placeholder="¿Cómo te sentiste aprendiendo?"
                            class="w-100"></textarea>
                        <button type="submit" class="button button-md button--primary w-100">Subir</button>
                    </form>
                </div>
            </div>
        </div>
