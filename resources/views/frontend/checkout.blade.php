        ...
        <div class="row">
                                ...
                                <div class="mb-4">
                                    <div class="ps-0 ">
                                        <label class="text-danger"> *
                                            Porfavor verifica tus cursos antes de pagar
                                        </label>
                                    </div>
                                </div>
                                <button type="submit" class="button button-lg button--primary w-100"> Click para
                                    Confirmar
                                    Pago</button>
                            </form>
                        </div>
            ...
            <div class="col-lg-6 mt-4 mt-lg-0">
                <div class="checkout-area-summery">
                    <h6 class="checkout-area__label">Resumen</h6>
                    ...
                    <div class="cart">
                        ...
                        <div class="cart__checkout-process">
                            <ul>
                                ...
                                <li>
                                    <p>Cupón de Descuento ({{session('cart_details')['discount'] ?? 0.00}}%)</p>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 offset-xl-3 order-2 order-xl-0">
                        <div class="signup-area-textwrapper">
                            <h2 class="font-title--md mb-0">Inicia Sesión Antes de Pagar</h2>
                            <p class="mt-2 mb-lg-4 mb-3">¿Aún no tienes una cuenta?
                                <a href="#" onclick="hide_signin()" class="text-black-50">Registrarse</a>
                            </p>
                            <form action="{{route('studentLogin.check','checkout')}}" method="POST">
                                ...
                                <div class="form-element">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="forget-password.html" class="text-primary fs-6">Olvide mi contraseña</a>
                                    </div>
                                    <div class="form-alert-input">
                                        <input type="password" placeholder="Escribe aquí..." id="password"
                                            name="password" />
                                ...
                                <div class="form-element">
                                    <button type="submit" class="button button-lg button--primary w-100">Iniciar
                                        Sesión</button>
                                </div>
                            </form>
                        </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-md-center">
                    <div class="col-lg-5 order-2 order-lg-0">
                        <div class="signup-area-textwrapper">
                            <h2 class="font-title--md mb-0">Registrate Antes de Pagar</h2>
                            <p class="mt-2 mb-lg-4 mb-3">¿Ya tienes una cuenta? <a href="#" onclick="hide_signin()"
                                    class="text-black-50">Iniciar Sesión</a></p>
                            <form action="{{route('studentRegister.store','checkout')}}" method="POST">
                                @csrf
                                <div class="form-element">
                                    <label for="name">Nombre completo</label>
                                    <input type="text" placeholder="Escribe tu nombre..." id="name" value="{{old('name')}}"
                                        name="name" />
                                    @if($errors->has('name'))
                                ...
                                <div class="form-element">
                                    <label for="password" class="w-100" style="text-align: left;">contraseña</label>
                                    <div class="form-alert-input">
                                        <input type="password" placeholder="Escribe aquí..." id="password"
                                            name="password" />
                                        <div class="form-alert-icon" onclick="showPassword('password',this)">
                                ...
                                <div class="form-element">
                                    <label for="password_confirmation" class="w-100" style="text-align: left;">Confirmar
                                        contraseña</label>
                                    <div class="form-alert-input">
                                        <input type="password" placeholder="Escribe aquí..." name="password_confirmation"
                                ...
                                <div class="form-element d-flex align-items-center terms">
                                    ...
                                    <label for="agree" class="text-secondary mb-0">Acepta los <a href="#"
                                            style="text-decoration: underline;">Terminos</a> y <a href="#"
                                            style="text-decoration: underline;">Política de Privacidad</a></label>
                                </div>
                                <div class="form-element">
                                    <button type="submit" class="button button-lg button--primary w-100">Registrase</button>
                                </div>
                            </form>
                        </div>
                    </div>
