    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center bg-transparent p-0 mb-0">
                ...
                <li class="breadcrumb-item">
                    <a href="course-search.html" class="fs-6 text-secondary">Cursos</a>
                </li>
            </ol>
        </nav>
    </div>
                ...
                <div class="event-search-results">
                    <div class="event-search-results-heading">
                        <div class="nice-select" tabindex="0">
                            <span class="current">Más Vistos</span>
                            <ul class="list">
                                <li data-value="Nothing" data-display="category" class="option selected focus">
                                    Nada
                                </li>
                                <li data-value="1" class="option">Alguna opción</li>
                                <li data-value="2" class="option">Otra opción</li>
                                <li data-value="4" class="option">Potato</li>
                            </ul>
                        </div>
                        <p>{{$course->count()}} Resultados encontrados.</p>
