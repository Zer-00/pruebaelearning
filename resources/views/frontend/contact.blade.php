    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb pb-0 mb-0">
                ...
                <li class="breadcrumb-item active"><a href="contact.html" class="fs-6 text-secondary">Contacto</a></li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="hero__content-info">
                    <h2 class="font-title--md mb-0">Nuestras Áreas</h2>
...
<section class="section getin-touch overflow-hidden"
    ...
    <div class="container">
        <div class="row">
            <h2 class="font-title--md text-center">Ponte en Contacto</h2>
                ...
                <form action="#">
                    <div class="row g-3">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control form-control--focused" placeholder="Escribe aquí..."
                                id="name" />
                        </div>
                        <div class="col-lg-6">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" placeholder="Escribe aquí..." id="email" />
                        </div>
                    </div>
                    <div class="row my-lg-2 my-2">
                        <div class="col-12">
                            <label for="subject">Asunto</label>
                            <input type="text" id="subject" class="form-control" placeholder="Escribe aquí..." />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <label for="message">Mensajes</label>
                            <textarea id="message" placeholder="Escribe aquí..." class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="text-end">
                            <button type="submit" class="button button-lg button--primary fw-normal">Mandar
                                Mensaje</button>
                        </div>
                    </div>
                </form>
