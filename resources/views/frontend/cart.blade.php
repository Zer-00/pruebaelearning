    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center bg-transparent mb-0">
                ...
                <li class="breadcrumb-item active"><a href="cart.html" class="fs-6 text-secondary">Carrito</a></li>
            </ol>
        </nav>
    </div>
</div>
...
<section class="section cart-area pb-0">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                <h6 class="cart-area__label">{{count(session('cart', []))}} Cursos en Carrito</h6>
                @php $total = 0 @endphp
                @if (session('cart'))
            ...
            <div class="col-lg-4">
                <h6 class="cart-area__label">Resumen</h6>
                <div class="summery-wizard">
                    ...
                    <div class="summery-wizard-text">
                        <h6>Cupón de Descuento ({{session('cart_details')['discount'] ?? 0.00}}%)</h6>
                    ...
                    <form action="{{route('coupon_check')}}" method="post">
                        ...
                        <a href="{{route('checkout')}}"
                            class="button button-lg button--primary form-control mb-lg-3">Verificación</a>
                        <label for="coupon">Aplicar Cupón</label>
                        <div class="cart-input">
                            <input type="text" name="coupon" class="form-control" placeholder="Código de Cupón" id="coupon" />
                            <button type="submit" class="sm-button">Aplicar</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <section class="section cart-area pb-0">
            <div class="container text-center">
                ...
                <h5>Aún No Hay Cursos en Tu Carrito</h5>
            </div>
        </section>
        @endif
    </div>
