    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0">
                ...
                <li class="breadcrumb-item"><a href="course-search.html" class="fs-6 text-secondary">Cursos</a></li>
                <li class="breadcrumb-item d-none d-lg-inline-block"><a href="#"
                        class="fs-6 text-secondary">Detalles del Instructor</a></li>
                                ...
                                <div class="col-lg-12">
                                    <div class="instructor-rating-area d-flex">
                                        <div class="rating-number">
                                            ...
                                            <p>Calificaciones del Instructor</p>
                                        </div>
                                    ...
                                    <div class="students-feedback">
                                        <div class="students-feedback-heading">
                                            <h5>Comentarios de los Estudiantes <span>(57,685)</span></h5>
                                            <div class="right">
                                                <h6>Ordenar por:</h6>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                        <li><button class="dropdown-item" type="button">Calificación</button>
                                                        </li>
                                                        <li><button class="dropdown-item" type="button">Otra
                                                                Calificación</button></li>
                                                        <li><button class="dropdown-item" type="button">Otra
                                                                Calificación...</button></li>
                                                    </ul>
                                                </div>
                                    ...
                                    <div class="feedback-comment">
                                        <h6 class="font-title--card">Dejar una calificación</h6>
                                        ...
                                        <form action="#">
                                            ...
                                            <button type="submit"
                                                class="button button-lg button--primary float-end">Reseña</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
