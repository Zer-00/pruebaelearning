        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center bg-transparent p-0 mb-0">
                <li class="breadcrumb-item">
                    <a href="index.html" class="fs-6 text-secondary">Inicio</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="#" class="fs-6 text-secondary">Curso</a>
                </li>
            ...
            <div class="col-lg-4">
                <div class="icon-with-date d-flex align-items-lg-center">
                    <div class="icon-with-date-start d-flex align-items-center">
                        ...
                        <p class="font-para--md">5.0 Estrellas <span>(2,54,879)</span></p>
                    </div>
                    <div class="icon-with-date-end d-flex align-items-center">
                        ...
                        <p class="font-para--md">{{$course->duration}} Horas</p>
                    </div>
                </div>
                <div class="icon-with-date d-flex align-items-lg-cente mb-0">
                    <div class="icon-with-date-start d-flex align-items-center">
                        ...
                        <p class="font-para--md">19,97,2547 Inscripciones</p>
                    </div>
                    <div class="icon-with-date-end d-flex align-items-center">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <p class="font-para--md">{{$course->lesson}} Lección</p>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="curriculum-area">
                                        <div class="curriculum-area-top" role="button" data-bs-toggle="collapse"
                                            ...
                                            <div class="curriculum-area-top-start">
                                                ...
                                                <p class="font-para--lg">Comenzar</p>
                                            </div>
                                            ...
                                            <div class="curriculum-description">
                                                <div class="curriculum-description-start">
                                                    <p>
                                                        ...
                                                        <a href="#">1. Introducción a Adobe XD</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="curriculum-area">
                                        <div class="curriculum-area-top collapsed" role="button"
                                            ...
                                            <div class="curriculum-area-top-start">
                                                ...
                                                <p class="font-para--lg">Resumen del Proyecto</p>
                                            </div>
                                            <div class="curriculum-area-top-end">
                                                <div class="total-lesson">
                                                    <svg width="18" height="19" viewBox="0 0 18 19" fill="none"
                                    ...
                                    <div class="curriculum-area mb-0">
                                        <div class="curriculum-area-top collapsed" role="button"
                                            ...
                                            <div class="curriculum-area-top-start">
                                                ...
                                                <p class="font-para--lg">Wireframes de Baja Fidelidad</p>
                                            </div>
                                            <div class="curriculum-area-top-end">
                                                <div class="total-lesson">
                                                    <svg width="18" height="19" viewBox="0 0 18 19" fill="none"
                                            ...
                                            <div class="instructor-text">
                                                ...
                                                <div class="d-flex align-items-center instructor-text-bottom">
                                                    <div class="d-flex align-items-center ratings-icon">
                                                        ...
                                                        <p class="font-para--md">4.9 Estrellas</p>
                                                    </div>
                                                    <div class="d-flex align-items-center ratings-icon">
                                                        ...
                                                        <p class="font-para--md">5 Cursos</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="course">
                                                ...
                                                <div class="course__content">
                                                    <div class="course__content_title">
                                                        <h6>
                                                            <a href="#">Arte Figital para Principiantes - Descubre Tu
                                                                Creatividad</a>
                                                        </h6>
                                                    </div>
                                                    <div class="course__content_author">
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="course">
                                                ...
                                                <div class="course__content">
                                                    <div class="course__content_title">
                                                        <h6>
                                                            <a href="#">¡Coloreamos un Goblin en Procreate!
                                                                Completo
                                                                Color...</a>
                                                        </h6>
                                                    </div>
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="course">
                                                ...
                                                <div class="course__content">
                                                    <div class="course__content_title">
                                                        <h6>
                                                            <a href="#">2020 Masterclass Completa Sobre Dibujo. De`
                                                                Principiante
                                                                a...</a>
                                                        </h6>
                                                    </div>
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="course">
                                                ...
                                                <div class="course__content">
                                                    <div class="course__content_title">
                                                        <h6>
                                                            <a href="#">Masterclass de Diseño Gráfico - Aprende
                                                                Diseño...</a>
                                                        </h6>
                                                    </div>
                                                    <div class="course__content_author">
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="course">
                                                ...
                                                <div class="course__content">
                                                    <div class="course__content_title">
                                                        <h6>
                                                            <a href="#">Conceptos Avanzados de Coloreo en Comics
                                                                &amp;
                                                                Técnicas</a>
                                                        </h6>
                                                    </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="course">
                                                ...
                                                <div class="course__content">
                                                    <div class="course__content_title">
                                                        <h6>
                                                            <a href="#">Gamificación: Motivación, Psicología &amp;
                                                                El
                                                                Arte de...</a>
                                                        </h6>
                                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="students-feedback">
                                                <div class="students-feedback-heading">
                                                    <h5 class="font-title--card">Comentarios de los Estudiantes
                                                        <span>(57,685)</span>
                                                    </h5>
                                                    <div class="right">
                                                        <h6 class="font-para--md">Ordenar por:</h6>
                ...
                <div class="courseCard--wrapper">
                    <div class="cart">
                        ...
                        <div class="cart__checkout-process">
                            <p class="time-left text-center">quedan <span>5 horas</span> con este precio</p>
                            <form action="#">
                                <a href="{{route('add.to.cart', $course->id)}}"
                                    class="text-white button button-lg button--primary w-100">Añadir al Carrito</a>
                                <a href="{{route('checkout')}}"
                                    class="button button-lg button--primary-outline mt-3 w-100">Comprar Ahora</a>
                            </form>
                        </div>
                        <div class="cart__includes-info">
                            <h6 class="font-title--card">Esté curso incluye:</h6>
                            <ul>
                                <li>
                                    <span><img src="{{asset('frontend/dist/images/icon/dollar.png')}}"
                                            alt="dollar" /></span>
                                    <p class="font-para--md">Acceso de por Vida</p>
                                </li>
                                <li>
                                    <span><img src="{{asset('frontend/dist/images/icon/clock-2.png')}}"
                                            alt="clock" /></span>
                                    <p class="font-para--md">Garantía de Reembolso de 30 Días</p>
                                </li>
                                <li>
                                    <span><img src="{{asset('frontend/dist/images/icon/paper-plus.png')}}"
                                            alt="paper-plus" /></span>
                                    <p class="font-para--md">Archivos de Ejercicios Gratis</p>
                                </li>
                                <li>
                                    <span><img src="{{asset('frontend/dist/images/icon/airplay.png')}}"
                                            alt="airplay" /></span>
                                    <p class="font-para--md">Accede Desde Tu Teléfono, Tablet y TV</p>
                                </li>
                                <li>
                                    <span><img src="{{asset('frontend/dist/images/icon/clipboard.png')}}"
                                            alt="clipboard" /></span>
                                    <p class="font-para--md">Certificación al Completar</p>
                                </li>
                            </ul>
                        </div>
                        <div class="cart__share-content">
                            <h6 class="font-title--card">Compartir Esté Curso</h6>
